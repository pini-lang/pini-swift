...
final class IfElifElseLevelTests: XCTestCase {
    ...
    func testSameLevelIfElifElseValid() throws {
        let source = try loadPiniFixture("testSameLevelIfElifElseValid", filePath: #filePath)
    ...
    func testLongElifChainValid() throws {
        let source = try loadPiniFixture("testLongElifChainValid", filePath: #filePath)
        let output = try runProgram(source)
    ...
    func testNestedSameLevelIfElseValid() throws {
        let source = try loadPiniFixture("testNestedSameLevelIfElseValid", filePath: #filePath)
        let output = try runProgram(source)
    ...
    func testSingleLineBodyElifValid() throws {
        let source = try loadPiniFixture("testSingleLineBodyElifValid", filePath: #filePath)
        let output = try runProgram(source)
        XCTAssertEqual(output.trimmingCharacters(in: .whitespacesAndNewlines), "B")
    }
    ...
    func testElifDeeperThanIfRejected() throws {
        let source = try loadPiniFixture("testElifDeeperThanIfRejected", filePath: #filePath)
    ...
    func testElifShallowerThanIfRejected() throws {
        let source = try loadPiniFixture("testElifShallowerThanIfRejected", filePath: #filePath)
    ...
    func testElseShallowerThanIfRejected() throws {
        let source = try loadPiniFixture("testElseShallowerThanIfRejected", filePath: #filePath)
    ...
    func testElseDeeperThanIfRejected() throws {
        let source = try loadPiniFixture("testElseDeeperThanIfRejected", filePath: #filePath)
    ...
    func testOrphanElifRejected() throws {
        let source = try loadPiniFixture("testOrphanElifRejected", filePath: #filePath)
    ...
    func testOrphanElseRejected() throws {
        let source = try loadPiniFixture("testOrphanElseRejected", filePath: #filePath)
    ...
    func testElseDoesNotMatchWhile() throws {
        let source = try loadPiniFixture("testElseDoesNotMatchWhile", filePath: #filePath)
    ...
    func testElifAfterElseRejected() throws {
        let source = try loadPiniFixture("testElifAfterElseRejected", filePath: #filePath)
