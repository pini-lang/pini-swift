...
final class MatchErrorTests: XCTestCase {
    ...
    func testUnmatchedEnumThrows() throws {
        let source = try loadPiniFixture("testUnmatchedEnumThrows", filePath: #filePath)
        do {
    ...
    func testUnmatchedEnumWithDefaultNoThrow() throws {
        let source = try loadPiniFixture("testUnmatchedEnumWithDefaultNoThrow", filePath: #filePath)
    ...
    func testUnmatchedEnumWithWildcardNoThrow() throws {
        let source = try loadPiniFixture("testUnmatchedEnumWithWildcardNoThrow", filePath: #filePath)
        let output = try runProgram(source)
    ...
    func testDuplicatePositionalBindingUsesEnumeratedIndex() throws {
        let source = try loadPiniFixture("testDuplicatePositionalBindingUsesEnumeratedIndex", filePath: #filePath)
        let output = try runProgram(source)
