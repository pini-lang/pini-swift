...
final class ValueSemanticsTests: XCTestCase {
    ...
    func testLetReassignmentReported() throws {
        let source = try loadPiniFixture("testLetReassignmentReported", filePath: #filePath)
    ...
    func testVarReassignmentNoError() throws {
        let source = try loadPiniFixture("testVarReassignmentNoError", filePath: #filePath)
        let diagnostics = checkCollecting(source)
    ...
    func testLetReassignmentIsOnlyDiagnostic() throws {
        let source = try loadPiniFixture("testLetReassignmentIsOnlyDiagnostic", filePath: #filePath)
        let diagnostics = checkCollecting(source)
    ...
    func testEnumMatchBindingNarrowing() throws {
        let source = try loadPiniFixture("testEnumMatchBindingNarrowing", filePath: #filePath)
        let diagnostics = checkCollecting(source)
    ...
    func testEnumVariantToUnionAssignable() throws {
        let source = try loadPiniFixture("testEnumVariantToUnionAssignable", filePath: #filePath)
        let diagnostics = checkCollecting(source)
    ...
    func testLetReassignmentRuntimeError() throws {
        let source = try loadPiniFixture("testLetReassignmentRuntimeError", filePath: #filePath)
    ...
    func testStructCopySemantics() throws {
        let source = try loadPiniFixture("testStructCopySemantics", filePath: #filePath)
    ...
    func testObjectReferenceSharing() throws {
        let source = try loadPiniFixture("testObjectReferenceSharing", filePath: #filePath)
        let output = try runProgram(source)
    ...
    func testLetMemberReassignmentReported() throws {
        let source = try loadPiniFixture("testLetMemberReassignmentReported", filePath: #filePath)
        let diagnostics = checkCollecting(source)
        let hit = diagnostics.contains {
    ...
    func testLetMemberReassignmentRuntimeError() throws {
        let source = try loadPiniFixture("testLetMemberReassignmentRuntimeError", filePath: #filePath)
    ...
    func testMemberAssignTypeMismatchReported() throws {
        let source = try loadPiniFixture("testMemberAssignTypeMismatchReported", filePath: #filePath)
        let diagnostics = checkCollecting(source)
        let hit = diagnostics.contains {
    ...
    func testArrayUnknownMemberReported() throws {
        let source = try loadPiniFixture("testArrayUnknownMemberReported", filePath: #filePath)
        let diagnostics = checkCollecting(source)
        let hit = diagnostics.contains {
    ...
    func testCollectionAliasIsValueSemantics() throws {
        let out = try runProgram(try loadPiniFixture("testCollectionAliasIsValueSemantics", filePath: #filePath) as String)
    ...
    func testContainerElementSnapshotIsIndependent() throws {
        let out = try runProgram(try loadPiniFixture("testContainerElementSnapshotIsIndependent", filePath: #filePath) as String)
    ...
    func testNestedSubscriptWriteAndCOW() throws {
        let out = try runProgram(try loadPiniFixture("testNestedSubscriptWriteAndCOW", filePath: #filePath) as String)
