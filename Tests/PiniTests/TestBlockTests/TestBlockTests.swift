...
final class TestBlockTests: XCTestCase {
    ...
    func testParseTestBlockBareForm() throws {
        let module = try parse(source: try loadPiniFixture("testParseTestBlockBareForm", filePath: #filePath) as String)
    ...
    func testTestBlockAllowsParams() throws {
        let module = try parse(source: try loadPiniFixture("testTestBlockAllowsParams", filePath: #filePath) as String)
    ...
    func testSemanticCheckAcceptsTestBlock() throws {
        let module = try parse(source: try loadPiniFixture("testSemanticCheckAcceptsTestBlock", filePath: #filePath) as String)
