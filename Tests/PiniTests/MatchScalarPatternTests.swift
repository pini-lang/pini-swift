...
final class MatchScalarPatternTests: XCTestCase {
    ...
    func testIntLiteralPattern() throws {
        let source = try loadPiniFixture("testIntLiteralPattern", filePath: #filePath)
    ...
    func testStringLiteralPattern() throws {
        let source = try loadPiniFixture("testStringLiteralPattern", filePath: #filePath)
    ...
    func testBoolLiteralPattern() throws {
        let source = try loadPiniFixture("testBoolLiteralPattern", filePath: #filePath)
    ...
    func testFloatLiteralPattern() throws {
        let source = try loadPiniFixture("testFloatLiteralPattern", filePath: #filePath)
    ...
    func testWildcardPatternMatchesAnyScalar() throws {
        let source = try loadPiniFixture("testWildcardPatternMatchesAnyScalar", filePath: #filePath)
    ...
    func testWildcardPatternMatchesEnum() throws {
        let source = try loadPiniFixture("testWildcardPatternMatchesEnum", filePath: #filePath)
    ...
    func testScalarNoMatchSilent() throws {
        let source = try loadPiniFixture("testScalarNoMatchSilent", filePath: #filePath)
