...
final class CallSiteTupleTests: XCTestCase {
    ...
    func testTupleArgumentTypeMismatch() throws {
        let source = try loadPiniFixture("testTupleArgumentTypeMismatch", filePath: #filePath)
    ...
    func testTupleArgumentTypeMatch() throws {
        let source = try loadPiniFixture("testTupleArgumentTypeMatch", filePath: #filePath)
    ...
    func testTupleArgumentCountMismatch() throws {
        let source = try loadPiniFixture("testTupleArgumentCountMismatch", filePath: #filePath)
    ...
    func testNestedTupleMismatch() throws {
        let source = try loadPiniFixture("testNestedTupleMismatch", filePath: #filePath)
    ...
    func testNestedTupleMatch() throws {
        let source = try loadPiniFixture("testNestedTupleMatch", filePath: #filePath)
