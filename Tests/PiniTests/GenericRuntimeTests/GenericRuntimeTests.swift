...
final class GenericRuntimeTests: XCTestCase {
    ...
    func testGenericStructConstructionAndMethodDispatch() throws {
        let source = try loadPiniFixture("testGenericStructConstructionAndMethodDispatch", filePath: #filePath)
    ...
    func testGenericStructTwoTypeParamsConstruction() throws {
        let source = try loadPiniFixture("testGenericStructTwoTypeParamsConstruction", filePath: #filePath)
        let output = try runProgram(source)
    ...
    func testGenericStructFieldReadViaMethod() throws {
        let source = try loadPiniFixture("testGenericStructFieldReadViaMethod", filePath: #filePath)
        let output = try runProgram(source)
    ...
    func testUndefinedGenericTypeStillThrows() throws {
        let source = try loadPiniFixture("testUndefinedGenericTypeStillThrows", filePath: #filePath)
    ...
    func testGenericFunctionCallRuntime() throws {
        let source = try loadPiniFixture("testGenericFunctionCallRuntime", filePath: #filePath)
        let output = try runProgram(source)
    ...
    func testGenericFunctionMultipleSpecializations() throws {
        let source = try loadPiniFixture("testGenericFunctionMultipleSpecializations", filePath: #filePath)
        let output = try runProgram(source)
