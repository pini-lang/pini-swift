...
final class CallSiteValidationTests: XCTestCase {
    ...
    func testArgumentCountTooFew() {
        let source = """
        foo|func(a: I32, b: I32,) -> ()
            return
        main|func() -> ()
            foo(1)
            return
    ...
    func testArgumentCountExactMatch() {
        let source = """
        foo|func(a: I32,) -> ()
            return
        main|func() -> ()
    ...
    func testVariadicPrintAcceptsManyArgs() {
        let source = """
        main|func() -> ()
            print(1, "a", true)
            return
    ...
    func testUntypedParamNoTypeConstraint() {
        let source = """
        foo|func(a, b,) -> ()
            return
        main|func() -> ()
