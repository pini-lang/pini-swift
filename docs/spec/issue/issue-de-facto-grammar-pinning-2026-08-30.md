...
- 状态：Proposed（2026-08-30，自举 parser S5/S6 探针产出；五项均为「宿主已实现但 spec 未钉定」的规范面；F5 由 S9 差分门禁阶段的用户质疑引出）。**F5 已于 2026-09-02 钉定落地（见 §F5 末裁决注记）；F1 已被 spec 投影主题钉定落地（2026-09-04 核验，见 §F1 末注记，E-112）；F2/F3/F4 仍 Proposed。**
