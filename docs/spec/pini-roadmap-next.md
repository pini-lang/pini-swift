...
| 项 | 提议载体 | 状态 | 备注 |
|---|---------|------|------|
| **F5 块文法钉定**（缩进块 + 顶格块 + 括号内记号流三维度） | `docs/spec/issue/issue-de-facto-grammar-pinning-2026-08-30.md` §F5 | ✅ **Landed（2026-09-02）**：spec §2.3 块文法 + EBNF 注消解（空行透明裁决）+ 差分探针入语料（MATCH 253） | 提议在册；裁决过程含「空行闭块」历史假设的否定 |
