...
| **IO 相对路径基准**（批 5） | `docs/spec/issue/proposal-io-path-base-2026-09-02.md`（①②，D-1~D-6 已裁决） | ✅ **Landed（2026-09-02，批 5）**：五阶段全走完（§8.1 批 5 行）；ADR-030 / G58 / A13 出账 / 迁移 §E / E-087..090 | 采方案 A 三段式；终验 = 自举从仓根直跑 70/0 |
