...
| ②影响评估 / 破坏性升级评审 | ✅ 非破坏性 | ⚠️ 破坏性，评审以 D-x 裁决表形式存在，未按 §1.3 记为升级评审 | ⚠️ 同左（且触及 G54） | 补「升级评审」记录（可并入 ADR） |
| ③§3 缺口登记 | ❌ 未新增缺口条目 | ⚠️ 仅修订既有 G48 行 | ⚠️ 仅修订既有规则 3.15 | 补 §3 新缺口条目 |
| ③ADR（决策理由） | ❌ | ❌（破坏性，应有） | ❌（破坏已钉定面，应有） | 补 ADR |
| ④spec 章节 | ✅ | ✅ | ✅ | — |
| ④`Pini草稿.md` rationale 同步 | ❌ | ❌ | ❌ | 补同步 |
| ④README / 示例 | ❌ 示例未加跨行用法 | ✅ | ✅ | 批 1.5 补示例 |
| ④迁移说明 | 不需要（新增能力） | ❌ | ❌ | 补迁移说明（破坏性变更必须） |
